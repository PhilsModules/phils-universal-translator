...
export class UniversalGlossary {
    ...
    static async ensureFoundryGlossaryJournal() {
        ...
        if (!journal) {
            ...
            const pages = [
                {
                    name: "Übersicht & Anleitung",
                    type: "text",
                    text: {
                        content: `<h2>Universal Übersetzungs-Glossar</h2>
<p>Dieses Glossar enthält alle offiziellen Übersetzungen und geschützten Eigennamen für deine Kampagne.</p>
<p><em>Hinweis:</em> Du kannst hier jederzeit Begriffe anpassen oder neue Zeilen hinzufügen. Das Übersetzungsmodul liest dieses Journal direkt aus und übernimmt alle Begriffe für KI-Prompts und automatische Wortersetzungen.</p>`
                    }
                }
            ];
